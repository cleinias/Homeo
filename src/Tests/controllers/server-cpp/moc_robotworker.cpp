...
#include "../server-supervisor-cpp/robotworker.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_RobotWorker_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_RobotWorker_t qt_meta_stringdata_RobotWorker = {
    {
QT_MOC_LITERAL(0, 0, 11), // "RobotWorker"
QT_MOC_LITERAL(1, 12, 11), // "sendCommand"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 7), // "command"
QT_MOC_LITERAL(4, 33, 3), // "run"
QT_MOC_LITERAL(5, 37, 13) // "handleCommand"
...
const QMetaObject RobotWorker::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_RobotWorker.data,
      qt_meta_data_RobotWorker,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *RobotWorker::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "webots::Supervisor"))
        return static_cast< webots::Supervisor*>(const_cast< RobotWorker*>(this));

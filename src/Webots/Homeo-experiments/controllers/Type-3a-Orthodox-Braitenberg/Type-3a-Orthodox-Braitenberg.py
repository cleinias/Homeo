...
# simulating a straightforward Braitenberg-like type-3a vehicle:
#
# 2 sensors and 2 motors, with NON crossed connections and
# negative (decreasing) connection between input and output)
#
...
class Vehicle2 (DifferentialWheels):
  ...
  def run(self):
    ...
    while (self.step(32) != -1):
      ...
      leftSpeed = maxSpeed - (leftLightValue * (maxSpeed/maxLight))
      rightSpeed = maxSpeed - (rightLightValue * (maxSpeed/maxLight))
